...
function drawFingerPrint(arr, size, sortInfo) {
	var div = document.createElement('div');
	
	var a = document.createElement('a');
	a.innerText = sortInfo.name;
	a.href=sortInfo.href;
	div.appendChild(a);
...
function createFingerprint(size, sort) {
	var arr = generateComparisonsArray(size, sort);

	return drawFingerPrint(arr, size, sort);
}
...
function main(sorts) {
	...
	sorts.forEach(function(sort) {
		rightColumn.appendChild(createFingerprint(size, sort));
	});
}
